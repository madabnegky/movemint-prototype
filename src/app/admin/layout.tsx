...
import { LayoutDashboard, ShoppingBag, LogOut, Palette, Play, ToggleLeft, Megaphone, Package, Eye, Home, ChevronDown, ChevronRight, Layers, Globe, Bell, Calendar, Calculator, PanelLeft, PanelLeftClose, X, TrendingUp, Handshake } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
    ...
    { name: "Partner Pipeline", href: "/admin/partners", icon: Handshake },
